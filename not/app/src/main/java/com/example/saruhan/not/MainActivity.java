...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startService(new Intent(MainActivity.this, Services.class));
                    Toast.makeText(MainActivity.this, "Sevices start", Toast.LENGTH_LONG).show();
        ...
        buttonStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Sevices stop", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    protected void onResume() {
        ...
        String  sEmail = sh1.getString("email","");
        String  sPassword = sh1.getString("password","");
        inputEmail.setText(sEmail);
        inputPassword.setText(sPassword);
        super.onResume();
    }
    @Override
    protected void onPause() {
        ...
        myEdit.putString("email", inputEmail.getText().toString());
        myEdit.putString("password", inputPassword.getText().toString());
        myEdit.commit();
        super.onPause();
    }
}
